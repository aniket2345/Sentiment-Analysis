...
all = "FulfillmentByAmazon+AmazonFBAHelp+Entrepreneur+AmazonUnder25+wtfamazon+AmazonSeller+bestofamazon+Amazon"
...
def sentiment():
    ...
    file = open("wordcloud_amazon.pickle","wb")
    ...
    file = open("final_second_amazon.pickle","wb")
    ...
    file = open("final_minute_amazon.pickle","wb")
