...
all = "Tesla+teslamotors+cars+electricvehicles+elonmusk+TeslaLounge+SelfDrivingCars+TeslaModel3+EnoughMuskSpam+RealTesla+TeslaModelY+TeslaAutonomy+"
...
def sentiment():
    ...
    for submission in reddit.subreddit(all).new(limit=50) :
    ...
    file = open("wordcloud_tesla.pickle","wb")
    ...
    file = open("final_second_tesla.pickle","wb")
    ...
    file = open("final_minute_tesla.pickle","wb")
